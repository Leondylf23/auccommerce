export default {
  ...
  item_detail_bid_place_validation_msg_max: 'Price must be lower than Rp. 25.000.000!',
  ...
  my_bids_pay_btn: 'Pay',
  my_bids_confirmation_msg: 'Are you sure want to complete this order?',
  my_bids_card_bid_date: 'Bid Date:',
  my_bids_card_complete_btn: 'Recieved',
  ...
  payment_step_2_est_time: 'Estimated time shipping',
  payment_step_2_est_price: 'Estimated price',
  ...
  auction_form_general_start_bid_err: 'Start bid minimum price Rp. 5.000 and maximum Rp. 15.000.000!',
  ...
  auction_form_item_spec_err_below_zero: 'Item specification must be greater than 0 and below 500!',
  auction_form_item_spec_err_weight_below_zero: 'Item weight must be greater than 0 and below 150000!',
  ...
  orders_card_detail_btn: 'Item Page',
  orders_detail_bid_info: 'Bid Information',
  orders_detail_item: 'Item',
  orders_detail_bid_plcd: 'Bid Placed',
  orders_detail_date: 'Placed Date',
  orders_detail_shipping_info: 'Shipping Information',
  orders_detail_address: 'Address',
  orders_detail_reciever: 'Reciever',
  orders_detail_phone: 'Phone',
  orders_detail_provider: 'Provider',
  orders_detail_est_time: 'Estimated Time',
  orders_detail_price: 'Price',
  orders_detail_confirm: 'Are you sure want to confirm this?',
};
