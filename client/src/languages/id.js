export default {
  ...
  item_detail_bid_place_validation_msg_max: 'Harga harus di bawah Rp. 25.000.000!',
  ...
  my_bids_confirmation_msg: 'Anda yakin ingin menyelesaikan pesanan ini?',
  my_bids_card_bid_date: 'Tanggal Penawaran:',
  my_bids_card_complete_btn: 'Diterima',
  ...
  payment_step_2_est_time: 'Perkiraan waktu sampai',
  payment_step_2_est_price: 'Perkiraan harga',
  ...
  auction_form_general_start_bid_err: 'Harga mulai lelang harus minimum Rp. 5.000 dan maksimum Rp. 15.000.000!',
  ...
  auction_form_item_spec_err_below_zero: 'Angka spesifikasi barang harus lebih dari 0 dan di bawah dari 500!',
  auction_form_item_spec_err_weight_below_zero: 'Angka berat barang harus lebih dari 0 dan di bawah dari 150000!',
  ...
  orders_page_title: 'Pesanan',
  orders_card_detail_btn: 'Halaman Barang',
  orders_detail_bid_info: 'Informasi Penawaran',
  orders_detail_item: 'Barang',
  orders_detail_bid_plcd: 'Ditawar',
  orders_detail_date: 'Tanggal Tawar',
  orders_detail_shipping_info: 'Informasi Pengiriman',
  orders_detail_address: 'Alamat',
  orders_detail_reciever: 'Penerima',
  orders_detail_phone: 'Telepon',
  orders_detail_provider: 'Penyedia Jasa',
  orders_detail_est_time: 'Estimasi Waktu',
  orders_detail_price: 'Harga',
  orders_detail_confirm: 'Anda yakin ingin konfirmasi pesanan ini?',
};
